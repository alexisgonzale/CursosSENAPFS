<main class="app-content">
    <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="<?php echo URL ?>preguntas/fromAprendiz">Preguntas</a>
          <li class="breadcrumb-item"><a href="<?php echo URL; ?>Preguntas/index">Añadir preguntas</a>
        </ul>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <h3 class="tile-title"><i class="fas fa-users"></i><b> Preguntas Aprendiz</b>
                </h3><hr>
                <div id="items">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">                                
                            <div class="card">
                                ...
                                <button class="btn btn-info float-right" data-toggle="modal" data-target="" title="Responder pregunta" onclick="editQuestions(<?= $value->idPregunta ?>)"><i class="fas fa-file-signature"></i></button>
                                </div>
                                <a onclick="return blmostrocult(this);" style="margin:5px; cursor: pointer;"><i class="fas fa-angle-down"></i></a><div style="display: none;padding: 10px;"> <p style="font-size:15px;"><b>Pregunta realizada por:</b> <?php echo $value->nombrePersona?> <?php echo $value->apellidoPersona?> <b>identificado</b> con <?php echo $value->nombreTipoDocumento?> <b>N° <?php echo $value->documentoPersona?></b></p><b>Fecha: (<?php echo $value->Fecha?>)</b></i></div>
                            </div>
                        </div>
                    </div>
                <?php endforeach;?>
...
<div class="modal fade" id="editQuestion" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form action="<?php echo URL ?>Preguntas/updateQuestionA" method="POST">
          <input class="form-control" name="txtCodigoPregunta" type="hidden" id="txtCodigoPregunta">
            <div class="form-group">
                <label class="control-label"><b>Pregunta <label style="color:red">*</label> </b></label>
                <input class="form-control" id="txtQuestionModal" maxlength="200" name="txtQuestionModal" type="text" placeholder="Escriba aquí su pregunta" readonly="readonly" style="border-radius:20px" required>
            </div>
              <label class="control-label"><b>Respuesta <label style="color:red">*</label> </b></label>
              <textarea class="form-control" placeholder="Ingrese aquí la respuesta correcta." maxlength="500" name="txtPublicacionModal" id="txtPublicacionModal" rows="5" style="border-radius:20px" required>
              </textarea><br>
          </div>
